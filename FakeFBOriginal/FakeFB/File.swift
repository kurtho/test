...
class Image {
    static var image = [Image(name: "1", description: "11111"), Image(name: "2", description: "22222"), Image(name: "moon", description: "moonnnnnn"), Image(name: "climb", description: "climbbbbbbbb")]
    var name : String
